<template>
  <div style="height: calc(100vh /20 ); display: flex;  justify-content: center;  align-items: center;border-bottom: 1px solid #ccc ;background-color: #545c64 ;display: flex;width: 100%">
